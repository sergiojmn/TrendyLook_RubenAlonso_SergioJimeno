...
@dso_cache = dso_local local_unnamed_addr global [1110 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 123912772, ; hash 0x762c244, from name: QRCoder
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 325370376, ; hash 0x1364c208, from name: Plugin.Maui.Calendar.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 432927181, ; hash 0x19cdf1cd, from name: aot-Plugin.Maui.Calendar
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.51_name, ; name: libaot-Plugin.Maui.Calendar.dll.so
		ptr null; void* handle (0x0)
	}, ; 118
	...
	%struct.DSOCacheEntry {
		i64 523314370, ; hash 0x1f3124c2, from name: aot-TrendyLook
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 677365583, ; hash 0x285fc74f, from name: libaot-Plugin.Maui.Calendar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.51_name, ; name: libaot-Plugin.Maui.Calendar.dll.so
		ptr null; void* handle (0x0)
	}, ; 181
	...
	%struct.DSOCacheEntry {
		i64 705766437, ; hash 0x2a112425, from name: aot-QRCoder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.52_name, ; name: libaot-QRCoder.dll.so
		ptr null; void* handle (0x0)
	}, ; 184
	...
	%struct.DSOCacheEntry {
		i64 894832054, ; hash 0x35560db6, from name: libaot-Plugin.Maui.Calendar
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.51_name, ; name: libaot-Plugin.Maui.Calendar.dll.so
		ptr null; void* handle (0x0)
	}, ; 228
	...
	%struct.DSOCacheEntry {
		i64 992238659, ; hash 0x3b245c43, from name: TrendyLook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TrendyLook.dll.so
		ptr null; void* handle (0x0)
	}, ; 248
	...
	%struct.DSOCacheEntry {
		i64 1175168641, ; hash 0x460ba681, from name: libaot-TrendyLook.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TrendyLook.dll.so
		ptr null; void* handle (0x0)
	}, ; 290
	...
	%struct.DSOCacheEntry {
		i64 1332067222, ; hash 0x4f65bb96, from name: aot-Plugin.Maui.Calendar.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.51_name, ; name: libaot-Plugin.Maui.Calendar.dll.so
		ptr null; void* handle (0x0)
	}, ; 328
	...
	%struct.DSOCacheEntry {
		i64 1387742246, ; hash 0x52b74426, from name: TrendyLook.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TrendyLook.dll.so
		ptr null; void* handle (0x0)
	}, ; 346
	...
	%struct.DSOCacheEntry {
		i64 1637494594, ; hash 0x619a2f42, from name: QRCoder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.52_name, ; name: libaot-QRCoder.dll.so
		ptr null; void* handle (0x0)
	}, ; 410
	...
	%struct.DSOCacheEntry {
		i64 1865111075, ; hash 0x6f2b5623, from name: aot-TrendyLook.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TrendyLook.dll.so
		ptr null; void* handle (0x0)
	}, ; 473
	...
	%struct.DSOCacheEntry {
		i64 2431711347, ; hash 0x90f0f873, from name: aot-QRCoder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.52_name, ; name: libaot-QRCoder.dll.so
		ptr null; void* handle (0x0)
	}, ; 627
	...
	%struct.DSOCacheEntry {
		i64 2902487066, ; hash 0xad00701a, from name: libaot-QRCoder.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.52_name, ; name: libaot-QRCoder.dll.so
		ptr null; void* handle (0x0)
	}, ; 753
	...
	%struct.DSOCacheEntry {
		i64 3098234835, ; hash 0xb8ab4fd3, from name: libaot-TrendyLook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TrendyLook.dll.so
		ptr null; void* handle (0x0)
	}, ; 810
	...
	%struct.DSOCacheEntry {
		i64 3135354210, ; hash 0xbae1b562, from name: Plugin.Maui.Calendar
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.51_name, ; name: libaot-Plugin.Maui.Calendar.dll.so
		ptr null; void* handle (0x0)
	}, ; 824
	...
	%struct.DSOCacheEntry {
		i64 4111902073, ; hash 0xf516a579, from name: libaot-QRCoder
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.52_name, ; name: libaot-QRCoder.dll.so
		ptr null; void* handle (0x0)
	}, ; 1046
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [215 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4

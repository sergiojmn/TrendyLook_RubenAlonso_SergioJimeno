...
public partial class TrendyLookContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdFecha).HasName("PK__citas__C4FBF54A344C699E");

            entity.ToTable("citas");

            entity.Property(e => e.IdFecha).HasColumnName("iddate");
            entity.Property(e => e.Fecha).HasColumnName("date");
            entity.Property(e => e.Description)
                .HasMaxLength(45)
                .IsUnicode(false)
                .HasColumnName("description");
            entity.Property(e => e.Hora).HasColumnName("hour");
        ...
        {
            entity.HasKey(e => e.IdEmpleado).HasName("PK__trabajad__046594075F0BBCFC");
            ...
            entity.Property(e => e.CitaIdFecha).HasColumnName("cita_iddate");
            entity.Property(e => e.CitaUsuariosIdUsuario).HasColumnName("cita_usuarios_iduser");
            ...
            entity.Property(e => e.Rango)
                ...
                .IsUnicode(false)
                .HasColumnName("range");
            entity.Property(e => e.UsuariosIdUsuario).HasColumnName("usuarios_iduser");
        });

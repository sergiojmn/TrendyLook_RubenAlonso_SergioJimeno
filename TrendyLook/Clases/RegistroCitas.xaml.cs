...
using Connectivity = Microsoft.Maui.Networking.Connectivity;
using ConnectivityChangedEventArgs = Microsoft.Maui.Networking.ConnectivityChangedEventArgs;
...
public partial class RegistroCitas : ContentPage
{
    ...
    private async void ComprobarConexion()
    {
        try
        {
            ...
            {
                btnBuscarCitas.IsEnabled = false;
                btnMisCitas.IsEnabled = false;
            }
            else
            {
                btnBuscarCitas.IsEnabled = true;
                btnMisCitas.IsEnabled = true;
            }
        }
        catch (Exception)
        {
